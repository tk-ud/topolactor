...
WITH upserted_preset AS (
    ...
    VALUES
        ...
        ((SELECT preset_id FROM preset), 'file_type_input', 'file_type_input', 'catalog_component', 'form_field.template', 'form_input/form_field', 'export_job_shell', 'fields', 6, '{"x":496,"y":232,"width":456,"height":64}'::jsonb, '{"label":"File type","required":false,"hint":"pdf / csv / json / zip"}'::jsonb, '{"layoutIntent":"file_type_input"}'::jsonb, 'mapped'),
...
VALUES (
    ...
    $${"nodes":[
      ...
      {"nodeId":"file_type_input","nodeKind":"catalog_component","componentKey":"form_field.template","componentKind":"form_input/form_field","isDraftOnly":false,"slotKey":"fields","orderIndex":6,"parentNodeId":"export_job_shell","x":496,"y":232,"width":456,"height":64,"propsJson":"{\"label\":\"File type\",\"required\":false,\"hint\":\"pdf / csv / json / zip\"}"},
