...
VALUES (
    ...
    'instance_settings_action_bundle',
    'manifest',
...
-- enum_authority / explicit_confirm / write / diff_log) -- UPDATED 2026-07-23,
-- second pass after PR #597 owner review. The admin_runtime dispatch
-- TRANSPORT gap recorded in the first pass (no wiring_lane_contract lane
-- covering generic admin_runtime layer:action dispatch) is now resolved and
-- consumed for READ: this manifest's wiring row dispatches a real
-- enum_dictionary:list_groups call (see ui_wiring_registry/ui_topology_tensor
-- above), so this is no longer the ADMIN_OPERATION_NOT_FOUND structural-render
-- fallback -- real enum.groups rows flow into emission.data and render in
-- enum_table.
--
...
-- enum_create_group_button) / Form enum_delete_group_form (Field
-- enum_delete_group_confirm_input + Action enum_delete_group_button) +
...
--
-- enum_delete_group_form (round 20, same Bundle): the SECOND operation wired
-- in, and the first one that needs an EXISTING record's identity rather than
-- fresh user input. enum_table's row-select event now ALSO writes
-- `value: row` into its own emitBoundEvent payload (runtimeComponentFactory.ts
...
-- prohibits a mutation Action without an owning Form that itself has at least
-- one Field (EMPTY_FORM / ACTION_NOT_OWNED_BY_FORM_OR_WORKFLOW). The
-- remaining 7 operations (update_group/get_group/create_item/update_item/
-- delete_item/set_group_items/list_groups already served by this layout's own
-- default target_ref) are NOT yet wired into this surface -- see
...
VALUES (
    ...
    'fixed_form_projection',
    '{"records":[{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"admin_enum_management_projection","record":{"recordType":"topology_ui_category","key":"enum_dictionary","label":"Enum dictionary","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum"],"sourceReactPath":"$.root.children[0]","knownGapRefs":[],"categoryKey":"enum_dictionary","sectionKeys":["enum_dictionary_roster"]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_dictionary","record":{"recordType":"topology_ui_section","key":"enum_dictionary_roster","label":"Enum groups and items","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract"],"sourceReactPath":"$.root.children[0].children[0]","knownGapRefs":[],"sectionKey":"enum_dictionary_roster","sectionKind":"enum_group_and_item_management_projection","childKeys":["enum_search","enum_group_filter","enum_table","enum_confirm_form","enum_create_group_form","enum_delete_group_form","enum_write_dispatch_gap"]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_dictionary_roster","record":{"recordType":"topology_ui_field","key":"enum_search","label":"Enum search","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.component_tree"],"sourceReactPath":"$.root.children[0].children[0].children[0]","knownGapRefs":[],"fieldKey":"enum_search","control":"form_input/search_input","required":false,"validationRefs":[]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_dictionary_roster","record":{"recordType":"topology_ui_field","key":"enum_group_filter","label":"Group filter","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.component_tree"],"sourceReactPath":"$.root.children[0].children[0].children[1]","knownGapRefs":[],"fieldKey":"enum_group_filter","control":"form_input/select","required":false,"validationRefs":[]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_dictionary_roster","record":{"recordType":"topology_ui_table","key":"enum_table","label":"Enum groups and items table","sourceYamlRefs":["enum-dictionary-ssot.yaml#canonical_tables"],"sourceReactPath":"$.root.children[0].children[0].children[2]","knownGapRefs":[],"tableKey":"enum_table","source":"enum.groups","display":"table","columnKeys":[]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_dictionary_roster","record":{"recordType":"topology_ui_form","key":"enum_confirm_form","label":"Enum group or item edit and confirm","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.mutation_confirmation_contract"],"sourceReactPath":"$.root.children[0].children[0].children[3]","knownGapRefs":[],"authorityMarker":"draft_or_projection_only","formKey":"enum_confirm_form","target":"enum.groups","mode":"edit","fieldKeys":["enum_form"],"actionKeys":["enum_confirm_button"]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_confirm_form","record":{"recordType":"topology_ui_field","key":"enum_form","label":"Enum group or item edit fields","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.component_tree"],"sourceReactPath":"$.root.children[0].children[0].children[3].children[0]","knownGapRefs":[],"fieldKey":"enum_form","control":"form_input/form_field","required":false,"validationRefs":[]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_confirm_form","record":{"recordType":"topology_ui_action","key":"enum_confirm_button","label":"Confirm changes","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.mutation_confirmation_contract"],"sourceReactPath":"$.root.children[0].children[0].children[3].children[1]","knownGapRefs":[],"authorityMarker":"draft_or_projection_only","actionKey":"enum_confirm_button","actionRef":"ui-local:enum_confirm_button.open_confirm","eventBinding":{"trigger":"click","wiringLane":"internal_instance_wiring","targetRef":"ui-local:enum_confirm_button.open_confirm","authority":"draft_or_projection_only"},"runtimeInteractions":[{"trigger":"click","actionType":"localStateMutation","payloadFrom":{},"sourceActionKey":"enum_confirm_button","targetRef":"ui-local:enum_confirm_button.open_confirm"}]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_dictionary_roster","record":{"recordType":"topology_ui_form","key":"enum_create_group_form","label":"Create enum group","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.mutation_confirmation_contract"],"sourceReactPath":"$.root.children[0].children[0].children[4]","knownGapRefs":[],"authorityMarker":"draft_or_projection_only","formKey":"enum_create_group_form","target":"enum.groups","mode":"create","fieldKeys":["enum_create_group_name_input"],"actionKeys":["enum_create_group_button"]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_create_group_form","record":{"recordType":"topology_ui_field","key":"enum_create_group_name_input","label":"Group name","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.component_tree"],"sourceReactPath":"$.root.children[0].children[0].children[4].children[0]","knownGapRefs":[],"fieldKey":"enum_create_group_name_input","control":"form_input/form_field","required":true,"validationRefs":[]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_create_group_form","record":{"recordType":"topology_ui_action","key":"enum_create_group_button","label":"Create group","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.mutation_confirmation_contract"],"sourceReactPath":"$.root.children[0].children[0].children[4].children[1]","knownGapRefs":[],"authorityMarker":"draft_apply_not_execution_authority","actionKey":"enum_create_group_button","actionRef":"manifest:00000000-0000-0000-0000-0000000ae210:enum_dictionary:create_group","eventBinding":{"trigger":"click","wiringLane":"admin_runtime_dispatch_override_wiring","targetRef":"manifest:00000000-0000-0000-0000-0000000ae210:enum_dictionary:create_group","authority":"draft_apply_not_execution_authority","payloadFrom":{"groupName":"node:enum_create_group_name_input.value","confirmed":"literal:true"}},"adminRuntimeDispatchOverride":{"trigger":"click","targetRef":"manifest:00000000-0000-0000-0000-0000000ae210:enum_dictionary:create_group","payloadFrom":{"groupName":"node:enum_create_group_name_input.value","confirmed":"literal:true"},"sourceActionKey":"enum_create_group_button"}}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_dictionary_roster","record":{"recordType":"topology_ui_form","key":"enum_delete_group_form","label":"Delete selected enum group","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.mutation_confirmation_contract"],"sourceReactPath":"$.root.children[0].children[0].children[5]","knownGapRefs":[],"authorityMarker":"draft_apply_not_execution_authority","formKey":"enum_delete_group_form","target":"enum.groups","mode":"delete","fieldKeys":["enum_delete_group_confirm_input"],"actionKeys":["enum_delete_group_button"]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_delete_group_form","record":{"recordType":"topology_ui_field","key":"enum_delete_group_confirm_input","label":"Type the group name to confirm deletion","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.component_tree"],"sourceReactPath":"$.root.children[0].children[0].children[5].children[0]","knownGapRefs":[],"fieldKey":"enum_delete_group_confirm_input","control":"form_input/form_field","required":true,"validationRefs":[]}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_delete_group_form","record":{"recordType":"topology_ui_action","key":"enum_delete_group_button","label":"Delete selected group","sourceYamlRefs":["admin-normal-surface-projection-seed-ssot.yaml#surface_axes.admin.surfaces.enum.seed_contract.mutation_confirmation_contract"],"sourceReactPath":"$.root.children[0].children[0].children[5].children[1]","knownGapRefs":[],"authorityMarker":"draft_apply_not_execution_authority","actionKey":"enum_delete_group_button","actionRef":"manifest:00000000-0000-0000-0000-0000000ae230:enum_dictionary:delete_group","eventBinding":{"trigger":"click","wiringLane":"admin_runtime_dispatch_override_wiring","targetRef":"manifest:00000000-0000-0000-0000-0000000ae230:enum_dictionary:delete_group","authority":"draft_apply_not_execution_authority","payloadFrom":{"groupId":"node:enum_table.value.groupId","confirmed":"literal:true"}},"adminRuntimeDispatchOverride":{"trigger":"click","targetRef":"manifest:00000000-0000-0000-0000-0000000ae230:enum_dictionary:delete_group","payloadFrom":{"groupId":"node:enum_table.value.groupId","confirmed":"literal:true"},"sourceActionKey":"enum_delete_group_button"}}},{"type":"topology_ui_seed_record","seedKey":"admin.enum.management.projection","parentKey":"enum_dictionary_roster","record":{"recordType":"topology_ui_validation","key":"enum_write_dispatch_gap","label":"create_group and delete_group are now wired into this surface (admin_runtime_dispatch_override_wiring to ae210/ae230; delete_group groupId is sourced from enum_table own tracked selected-row value, node:enum_table.value.groupId); the remaining 5 write actions (update_group/create_item/update_item/delete_item/set_group_items) still resolve only via their own dedicated per-action manifests (ae220/ae240-ae270), not yet wired into this surface","sourceYamlRefs":["react-schema-topology-seed-translator-ssot.yaml#declared_seed_surface_catalog.known_declared_surfaces.admin_enum_management_projection.known_gaps"],"sourceReactPath":"$.root.children[0].children[0].children[6]","knownGapRefs":[],"validationKey":"enum_write_dispatch_gap","rule":"admin_runtime_write_target_partially_resolved_via_this_surface_remainder_via_dedicated_per_action_manifests","severity":"resolved"}}]}'::jsonb,
    'active'
)
ON CONFLICT (layout_id) DO UPDATE
    SET layout_schema_json = EXCLUDED.layout_schema_json,
...
-- enum_confirm_button's real, functioning interaction (local confirm state
-- open -- internal_instance_wiring, no backend dispatch) is unaffected: it is
-- carried on the SEPARATE enum_confirm_form tensor node below via Lane 3
-- (runtimeInteractions/localStateMutation), which overrides Lane 2's uniform
-- admin_runtime binding on that node's own click trigger.
INSERT INTO topology.ui_wiring_registry (wiring_id, wiring_key, wiring_kind, target_surface, target_ref, wiring_schema_json, status)
VALUES (
...
-- 2. enum_confirm_form: runtimeInteractions merge target, nodeId matches the
...
-- 4. enum_delete_group_button (round 20): same dispatchTargetRefByTrigger/
...
-- enum_delete_group_button) resolve from components_layout_design.records[]
-- above via the existing ui_component_registry preset catalog.
INSERT INTO topology.ui_topology_tensor (tensor_id, route_key, package_id, layout_id, wiring_id, slot_key, order_index, layout_patch_json)
VALUES (
    ...
    'default',
    0,
    '{"nodes":[{"nodeId":"enum_table","nodeKind":"catalog_component","propsJson":"{\"table\":null,\"columns\":[{\"key\":\"groupName\",\"header\":\"Group name\"},{\"key\":\"indexNum\",\"header\":\"Index\"},{\"key\":\"groupId\",\"header\":\"Group ID\"}]}","propBindings":{"rows":{"source":"emission.data"}}},{"nodeId":"enum_confirm_form","nodeKind":"catalog_component","runtimeInteractions":[{"trigger":"click","actionType":"localStateMutation","payloadFrom":{},"sourceActionKey":"enum_confirm_button","targetRef":"ui-local:enum_confirm_button.open_confirm"}]},{"nodeId":"enum_create_group_button","nodeKind":"catalog_component","dispatchTargetRefByTrigger":{"click":"manifest:00000000-0000-0000-0000-0000000ae210:enum_dictionary:create_group"},"dispatchPayloadFromByTrigger":{"click":{"groupName":"node:enum_create_group_name_input.value","confirmed":"literal:true"}}},{"nodeId":"enum_delete_group_button","nodeKind":"catalog_component","dispatchTargetRefByTrigger":{"click":"manifest:00000000-0000-0000-0000-0000000ae230:enum_dictionary:delete_group"},"dispatchPayloadFromByTrigger":{"click":{"groupId":"node:enum_table.value.groupId","confirmed":"literal:true"}}}]}'::jsonb
)
ON CONFLICT (route_key, package_id, layout_id, wiring_id, slot_key, order_index) DO UPDATE
    SET layout_patch_json = EXCLUDED.layout_patch_json;
