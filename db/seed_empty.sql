...
VALUES
    ...
    -- projection_scaffold_only | runtimeConnected:false | draft palette candidate
    ('document_canvas_template_editor.primitive','frontend/components/DocumentCanvasTemplateEditor.tsx','document_canvas/document_canvas_template_editor','bucketed','{"classification":{"runtimeConnected":false,"registrationRequired":true,"lifecycleStatus":"code_only_drift","componentFamily":"primitive","semanticRole":"admin_operation","visualRole":"canvas","capabilityTags":["accepts_design","accepts_layout","field_binding","preview_surface","export_snapshot","admin_only"]}}'::jsonb)
