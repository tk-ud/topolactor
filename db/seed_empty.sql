...
-- enum_create_group_button) + Validation enum_write_dispatch_gap (documents
-- the write-step gap, see header comment).
--
-- enum_create_group_form (round 19, admin-write-surface-selection-context-and-
-- mode-composition-gap Bundle): the FIRST of the 7 write actions
...
-- admin_runtime_target_ref_override_contract). The remaining 6 write actions
-- (update_group/delete_group/create_item/update_item/delete_item/
-- set_group_items) are NOT yet wired into this surface -- see
...
-- enum_create_group_button) resolve from components_layout_design.records[]
