...
-- ---------------------------------------------------------------------------
-- Secret Credential Bundle dispatch manifests (IDs c7-ca)
-- Routes credential_registry layer directly to secret_credential_runtime.
...
VALUES
    (
        ...
        NULL,
        ARRAY[
            '{"type":"dispatcher_mapping","role":"admin","target":"admin","layer":"credential_registry","action":"list"}'::jsonb,
            '{"type":"db_notify_projection_mapping","runtime_destination":"sse_projection_runtime"}'::jsonb,
            '{"type":"runtime_mapping","runtime_destination":"secret_credential_runtime"}'::jsonb
        ]::jsonb[],
        'active'
    ),
    (
        ...
        NULL,
        ARRAY[
            '{"type":"dispatcher_mapping","role":"admin","target":"admin","layer":"credential_registry","action":"register"}'::jsonb,
            '{"type":"db_notify_projection_mapping","runtime_destination":"sse_projection_runtime"}'::jsonb,
            '{"type":"runtime_mapping","runtime_destination":"secret_credential_runtime"}'::jsonb
        ]::jsonb[],
        'active'
    ...
    (
        ...
        NULL,
        ARRAY[
            '{"type":"dispatcher_mapping","role":"admin","target":"admin","layer":"credential_registry","action":"validate"}'::jsonb,
            '{"type":"db_notify_projection_mapping","runtime_destination":"sse_projection_runtime"}'::jsonb,
            '{"type":"runtime_mapping","runtime_destination":"secret_credential_runtime"}'::jsonb
        ]::jsonb[],
        'active'
    ...
    (
        ...
        NULL,
        ARRAY[
            '{"type":"dispatcher_mapping","role":"admin","target":"admin","layer":"credential_registry","action":"rotate"}'::jsonb,
            '{"type":"db_notify_projection_mapping","runtime_destination":"sse_projection_runtime"}'::jsonb,
            '{"type":"runtime_mapping","runtime_destination":"secret_credential_runtime"}'::jsonb
        ]::jsonb[],
        'active'
...
-- ---------------------------------------------------------------------------
-- Secret Credential Bundle structure_maps (IDs cd-d0)
-- Attractor keys for credential_registry actions routed via secret_credential_runtime.
-- SSOT: docs/design/runtime-bundle-secret-credential-ssot.yaml
-- ---------------------------------------------------------------------------
INSERT INTO topology.structure_maps (
    structure_map_id, name, attractor_key,
...
VALUES
    (
        ...
        'admin_credential_registry_list',
        'admin:credential_registry:list',
        '00000000-0000-0000-0000-000000000020',
        '00000000-0000-0000-0000-000000000021',
        ARRAY['00000000-0000-0000-0000-000000000022']::uuid[],
        true
    ...
    (
        ...
        'admin_credential_registry_register',
        'admin:credential_registry:register',
        '00000000-0000-0000-0000-000000000020',
        '00000000-0000-0000-0000-000000000021',
        ARRAY['00000000-0000-0000-0000-000000000022']::uuid[],
        true
    ...
    (
        ...
        'admin_credential_registry_validate',
        'admin:credential_registry:validate',
        '00000000-0000-0000-0000-000000000020',
        '00000000-0000-0000-0000-000000000021',
        ARRAY['00000000-0000-0000-0000-000000000022']::uuid[],
        true
    ...
    (
        ...
        'admin_credential_registry_rotate',
        'admin:credential_registry:rotate',
        '00000000-0000-0000-0000-000000000020',
        '00000000-0000-0000-0000-000000000021',
        ARRAY['00000000-0000-0000-0000-000000000022']::uuid[],
        true
