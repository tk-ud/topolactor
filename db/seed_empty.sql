...
VALUES
    ...
    ('00000000-0000-0000-0000-000000000479', '00000000-0000-0000-0000-0000000000eb', 9, 'record_transfer_lifecycle_evidence', '{"evidence_table_ref":"topology.sftp_transfer_log","projection_table_ref":"topology.sftp_transfer_log","completed_event_type":"transfer_completed","failed_event_type":"transfer_failed","checksum_mismatch_event_type":"checksum_mismatch","retry_event_type":"retry_attempted","requires_export_job":"true","requires_manifest":"true","requires_checksum":"true","retry_policy_ref":"scheduler_retry_requested"}', NULL, true)
ON CONFLICT (policy_id, step_order) DO NOTHING;
