...
export const COMPONENT_CATALOG_ENTRIES: ComponentCatalogEntry[] = [
  ...
  },
  {
    ...
    registrationRequired: false,
    notes:
      "dashboard/read-work component candidate for saved Markdown view display; runtime factory renders preview placeholder (not full MdViewer island); not a preset DB seed registration mechanism or package canvas edit root; not a UIBuilder preset_ecosystem child surface, active topology authority, physical record authority, or saved view authority",
  },
  {
    componentKey: "md_translation_authoring_surface.authoring",
    componentKind: "authoring/md_translation",
