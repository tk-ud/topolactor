...
/**
 * GET /api/draft-preview/drafts
 *
 * Proxies to DEMO_BACKEND_URL/draft-preview/drafts.
 * Returns { success, drafts } — list of content_entity_drafts with status='draft'.
...
export const handler: Handlers = {
  async GET(req) {
    ...
    try {
      ...
      const response = await fetch(`${backendUrl}/draft-preview/drafts`, { headers });
