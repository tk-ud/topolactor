...
|-----------|------|--------|------|---------|
| `layout-application-projection-continuity` | admin layout authoring → application projection continuity | partial | 1 | `docs/design/pipeline-continuity-ssot.yaml` |
