...
- [ ] `ad200`のproduction reachability: repo-wide grep（`00000000-0000-0000-0000-0000000ad200`）でtest file以外からの参照（route/mount point、または`/admin` index上のlink）が新たに見つかることを確認する。追加前はtest fileのみだったことをbefore/after証跡として残す。
