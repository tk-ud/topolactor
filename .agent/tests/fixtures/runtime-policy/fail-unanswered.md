# Runtime Policy Checklist — fixture: FAIL (unanswered / invalid answers)

Q2 and Q7 are left with invalid values. Expected result: FAIL with invalid-answer errors.
