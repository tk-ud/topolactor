# Runtime Policy Checklist — fixture: FAIL (policy violations)

Q2=yes and Q3=no (fallback present, no explicit error). Q4=no (value not from policy
surface). Q5=yes (silent fallback). Q6=yes (hardcoded constant).
Expected result: FAIL with multiple violation errors.
