...
check_term ".agent/protocols/reports-and-todos.md" "WorkEvent Output Sink Contract"
check_term ".agent/protocols/reports-and-todos.md" "existing_pr_update"
check_term ".agent/protocols/reports-and-todos.md" "PR body update never replaces required PR follow-up comment"
...
check_term ".agent/protocols/reports-and-todos.md" "### output sink state"
check_term ".agent/protocols/reports-and-todos.md" "PR follow-up comment posting state は"
