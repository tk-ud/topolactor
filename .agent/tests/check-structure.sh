...
check_content ".agent/tests/check-bootstrap-validation.sh" "db/schema.sql"
check_content ".agent/tests/check-bootstrap-validation.sh" "db/topology_tables.sql"
check_content ".agent/tests/check-bootstrap-validation.sh" "db/promotion_tables.sql"
check_content ".agent/tests/check-bootstrap-validation.sh" "db/context_route_tables.sql"
check_content ".agent/tests/check-bootstrap-validation.sh" "db/ui_topology_tables.sql"
check_content ".agent/tests/check-bootstrap-validation.sh" "db/manifest_tables.sql"
check_content ".agent/tests/check-bootstrap-validation.sh" "db/seed_empty.sql"
check_content ".agent/tests/check-bootstrap-validation.sh" "db/demo_seed.sql"
