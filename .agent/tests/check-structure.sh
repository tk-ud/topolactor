...
check_content ".agent/protocols/index.yaml" "routing hint only"
check_content ".agent/protocols/index.yaml" "purpose: Protocol grep index"
check_content ".agent/protocols/index.yaml" "version: 1"
...
check_content ".agent/docs/ssot-map.yaml" "grep_key_policy:"
