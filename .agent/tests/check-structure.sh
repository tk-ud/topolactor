...
check_file "docs/design/runtime-log-retention-scheduler.md"
check_file "docs/design/runtime-log-retention-scheduler.yaml"

check_file ".agent/docs/structure-map.yaml"
check_file ".agent/docs/required-paths.yaml"
check_file ".agent/docs/design-ssot-index.md"
...
check_content "docs/design/runtime-log-retention-scheduler.md" "retention policy"
check_content "docs/design/runtime-log-retention-scheduler.md" "silent fallback"
check_content "docs/design/runtime-log-retention-scheduler.md" "function_parameters"
check_content "docs/design/runtime-log-retention-scheduler.yaml" "runtime_log_retention_scheduler_run"
check_content "docs/design/runtime-log-retention-scheduler.yaml" "status_contract"
check_content "docs/design/runtime-log-retention-scheduler.yaml" "no_silent_fallback"
check_content ".agent/docs/design-ssot-index.md" "Runtime Log Retention Scheduler"
check_content ".agent/docs/design-ssot-index.md" "docs/design/runtime-log-retention-scheduler.yaml"
