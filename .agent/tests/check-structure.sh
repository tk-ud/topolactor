...
check_content "db/sql_attention_logs_tables.sql" "logs.table_attention"
check_content "db/sql_attention_logs_tables.sql" "logs.table_current"
...
check_content "docs/design/sql-attention-logs-ssot.md" "logs.table_current"
check_content "docs/design/sql-attention-logs-ssot.md" "logs.table_attention"
...
check_content "docs/design/pipeline-continuity-ssot.yaml" "not_implemented"
...
check_content "docs/design/pipeline-continuity-ssot.yaml" "gap_summary"
