...
check_content ".agent/protocols/reports-and-todos.md" "## Negative Consistency Gate"
check_content ".agent/protocols/reports-and-todos.md" "Answer:"
check_content ".agent/protocols/reports-and-todos.md" "Evidence:"
check_content ".agent/protocols/reports-and-todos.md" "Remaining risk:"
