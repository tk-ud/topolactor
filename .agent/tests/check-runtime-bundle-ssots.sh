...
check_content "$ROADMAP" "consumer_bundle_physical_table_manifest_evidence_projection_connected"
check_content "$ROADMAP" "hook_port_receive_scheduler_enqueue_boundary_guarded"
