...
check_content "$ROADMAP" "client_ui_consumer_portTargetRef_action_wiring_not_connected"
check_content "$ROADMAP" "hook_consumer_hook_port_receive_wiring_not_connected"
