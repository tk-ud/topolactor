...
check_term "backend/runtime/ExternalPortCredentialRefresher.cs" "IExternalPortStepConfigResolver"
check_term "backend/runtime/ExternalPortCredentialRefresher.cs" "EnvironmentVariableStepConfigResolver"
