...
check_term "backend/runtime/ExternalPortCredentialRefresher.cs" "IExternalPortEndpointReferenceResolver"
check_term "backend/runtime/ExternalPortCredentialRefresher.cs" "EnvironmentVariableEndpointReferenceResolver"
