...
check_term "$REPO_ROOT/.agent/prompt/implementation-change.md" "docs/framework-policy.yaml"
...
check_term "$REPO_ROOT/.agent/prompt/implementation-change.md" "docs/design/db-schema.yaml"
check_term "$REPO_ROOT/.agent/prompt/implementation-change.md" "framework_policy_read"
check_term "$REPO_ROOT/.agent/prompt/implementation-change.md" "db_schema_read"

# foundation SSOT baseline (framework-core / framework-policy / runtime-orchestration / pipeline-continuity + conditional db-schema)
# must stay aligned across every substantive worktype, not just audit/implementation_change.
check_term "$REPO_ROOT/.agent/prompt/design-change.md" "docs/framework-core.yaml"
check_term "$REPO_ROOT/.agent/prompt/design-change.md" "docs/framework-policy.yaml"
check_term "$REPO_ROOT/.agent/prompt/design-change.md" "docs/design/runtime-orchestration-ssot.yaml"
check_term "$REPO_ROOT/.agent/prompt/design-change.md" "docs/design/pipeline-continuity-ssot.yaml"
check_term "$REPO_ROOT/.agent/prompt/design-change.md" "docs/design/db-schema.yaml"
check_term "$REPO_ROOT/.agent/prompt/design-change.md" "framework_policy_read"
check_term "$REPO_ROOT/.agent/prompt/design-change.md" "db_schema_read"
check_term "$REPO_ROOT/.agent/protocols/design-change.md" "docs/design/runtime-orchestration-ssot.yaml"
check_term "$REPO_ROOT/.agent/protocols/design-change.md" "docs/design/pipeline-continuity-ssot.yaml"

check_term "$REPO_ROOT/.agent/prompt/todo-maintenance.md" "docs/framework-policy.yaml"
check_term "$REPO_ROOT/.agent/prompt/todo-maintenance.md" "docs/design/db-schema.yaml"
check_term "$REPO_ROOT/.agent/prompt/todo-maintenance.md" "framework_policy_read"
check_term "$REPO_ROOT/.agent/prompt/todo-maintenance.md" "db_schema_read"

check_term "$REPO_ROOT/.agent/prompt/existing-pr-update.md" "docs/framework-policy.yaml"
check_term "$REPO_ROOT/.agent/prompt/existing-pr-update.md" "docs/design/db-schema.yaml"
check_term "$REPO_ROOT/.agent/prompt/existing-pr-update.md" "framework_policy_read"
check_term "$REPO_ROOT/.agent/prompt/existing-pr-update.md" "db_schema_read"
check_term "$REPO_ROOT/.agent/protocols/completion-summary.md" "foundation_ssot_read_gate"
check_term "$REPO_ROOT/.agent/protocols/completion-summary.md" "docs/framework-policy.yaml"
