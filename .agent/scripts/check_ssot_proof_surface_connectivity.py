...
UNCONNECTED_SSOT_ALLOWLIST = {
    ...
    "docs/design/backend-error-evidence-report-notify-ssot.yaml":
        "governance/design SSOT for the backend system error evidence / report / notify "
        "substrate (PR536, status partial); validated through agent read-routing "
        "(.agent/docs/ssot-map.yaml) and docs/system-roadmap.yaml; no dedicated check-*.sh "
        "literal-reference proof surface exists yet.",
    "docs/design/runtime-bundle-export-sftp-implementation-ssot.yaml":
        "implementation-decomposition SSOT for export_sftp_bundle, subordinate to the "
        "boundary-checked runtime-bundle-export-sftp-ssot.yaml (referenced directly in "
        "check-structure.sh); validated through agent read-routing "
        "(.agent/docs/ssot-map.yaml) and docs/system-roadmap.yaml; no dedicated check-*.sh "
        "literal-reference proof surface exists yet.",
    "docs/design/ui-builder-seed-first-gap-discovery-ssot.yaml":
        "governance/design SSOT referenced from ui-builder-preset-ecosystem-ssot.yaml "
        "seed_first_method_ssot and .agent/docs/ssot-map.yaml; no dedicated check-*.sh "
        "literal-reference proof surface exists yet.",
}
