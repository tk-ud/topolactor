...
/// NodeKind is "catalog_component" | "structural_html" | "structural_node".
...
public record LayoutNode(
    ...
    /// <summary>Authored display label for a structural_node. Null for non-structural nodes.</summary>
    string? Label = null
);
