...
public class LayoutSchemaStructuralCompositionTests
{
    ...
    // entry in react_schema_contract.allowed_node_kinds -- a real translator/SSOT expressiveness gap,
    // not an authoring ambiguity, and out of this Bundle's scope to fix since translator extension is
    // not this Bundle's primary work (see the corrected knownGapRefs classification,
    // runtime_dispatch_or_projection_gap, in the checked-in translator input fixture).
